...
- 🔐 Auth (register/login, JWT in Keychain), favorite cities (add + swipe-to-delete), search history, saved unit preference
...
│                    # Favorites, History, Settings (incl. admin user list), MainTabView
